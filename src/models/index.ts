...
export interface LookalikeItem {
  name: string;
  type: 'NUTRIENT' | 'DISEASE' | 'PEST' | 'PHYSIOLOGICAL';
  overlap_symptoms: string;
  distinguishing_feature: string;
  confirmation_advice: string;
}

export interface SymptomCrosscheck {
...
export interface DifferentialAssessment {
  ...
  symptom_crosscheck?: SymptomCrosscheck;
  farmer_action_checklist?: string[];
  source_verification?: string;
}
